...
class FlxTouch extends FlxPointer implements IFlxDestroyable implements IFlxInput
{
	...
	{
		openflPoint.setTo(X, Y);
		openflPoint = FlxG.game.globalToLocal(openflPoint);

		setGlobalScreenPositionUnsafe(openflPoint.x, openflPoint.y);
	}
