...
class FlxTiledSprite extends FlxStrip
{
	...
	function updateRenderSprite():Void
	{
		...
		{
			_openflRect2.setTo(0, 0, width, height);
		...
		if (scrollX != 0 || scrollY != 0)
		{
			...
			FlxSpriteUtil.openflGfx.beginBitmapFill(graphic.bitmap, _matrix);
		}
		else
		{
		...
		FlxSpriteUtil.openflGfx.drawRect(rectX, rectY, rectWidth, rectHeight);
