...
/**
 * A really simple little class that solves an annoying problem with  font file names
 * @author larsiusprime
 */
class FontFixer
{
	...
	public static function add(file:String, name:String = ""):String
	{
		...
		#if 
		// edge case for : if we've got a mangled font file like "assets/fonts/Verdana Bold.ttf", strip it down to "Verdana Bold" and look up
