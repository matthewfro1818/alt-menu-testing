...
class FlxScreenGrab extends FlxBasic
{
	 ...
	 *
	 * @param	X		The x coordinate (in openfl display space, not Flixel game world)
	 * @param	Y		The y coordinate (in openfl display space, not Flixel game world)
	 ...
	 * @return	Bitmap			The screen grab as a openfl Bitmap image
	 */
