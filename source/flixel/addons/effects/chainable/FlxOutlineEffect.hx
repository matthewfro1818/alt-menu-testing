...
class FlxOutlineEffect implements IFlxEffect
{
	...
	/**
	 * The actual openfl BitmapData object representing the colored border.
	 */
	...
	public function apply(bitmapData:BitmapData):BitmapData
	{
		if (dirty)
		{
			...
			else
			{
				...
				_borderPixels.copyPixels(_pixels, _pixels.rect, _openflPoint, bitmapData, null, true);
		...
		if (_pixels != null)
		{
			...
			_openflPoint.setTo(thickness, thickness);
			_pixels.copyPixels(bitmapData, bitmapData.rect, _openflPoint, null, null, true);
