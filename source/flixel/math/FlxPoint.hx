...
class FlxPoint implements IFlxPooled
{
	...
	/**
	 * Helper function, just copies the values from the specified openfl point.
	 *
	 * @param	Point	Any Point.
	 * @return	A reference to itself.
	 */
	public inline function copyFromopenfl(openflPoint:Point):FlxPoint
	{
		x = openflPoint.x;
		y = openflPoint.y;
		return this;
	...
	/**
	 * Helper function, just copies the values from this point to the specified openfl point.
	 *
	 * @param	Point	Any Point.
	 * @return	A reference to the altered point parameter.
	 */
	public inline function copyToopenfl(openflPoint:Point):Point
	{
		if (openflPoint == null)
		{
			openflPoint = new Point();
		}
	...
	/**
	 * Helper function, just increases the values of the specified openfl point by the values of this point.
	 *
	 * @param	Point	Any Point.
	 * @return	A reference to the altered point parameter.
	 */
	public inline function addToopenfl(openflPoint:Point):Point
	{
		openflPoint.x += x;
		openflPoint.y += y;
	...
	/**
	 * Helper function, just decreases the values of the specified openfl point by the values of this point.
	 *
	 * @param	Point	Any Point.
	 * @return	A reference to the altered point parameter.
	 */
	public inline function subtractFromopenfl(openflPoint:Point):Point
	{
		openflPoint.x -= x;
		openflPoint.y -= y;
