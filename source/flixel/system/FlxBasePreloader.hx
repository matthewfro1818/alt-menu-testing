...
class FlxBasePreloader extends DefaultPreloader
{
	 ...
	 * @:bitmap metadata, if you want to support both openfl and HTML5. Because the embedded data is loaded
	...
	function isHostUrlAllowed():Bool
	{
		...
		var homeURL:String = #if openfl loaderInfo.loaderURL #elseif js js.Browser.location.href #else "" #end;
