...
/**
 * A generic, openfl-based window class, created for use in FlxDebugger.
 */
class Window extends Sprite
{
	...
	/**
	 * Creates a new window object.  This openfl-based class is mainly (only?) used by FlxDebugger.
	 *
	...
	{
		if (#if openfl root #else stage #end == null)
		{
			return;
		}
	...
	/**
	 * Update the openfl shapes to match the new size, and reposition the header, shadow, and handle accordingly.
	 */
